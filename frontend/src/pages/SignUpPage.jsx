...
const SignUpPage = () => {
  ...
  return (
    <div
      className="h-screen flex items-center justify-center p-4 $m:p-6 md:p-8 "
      data-theme="forest"
    >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm opacity-70 ">
                    Join LetsChat and start your language learning adventure
                    today!
                  </p>
                </div>
          ...
          <div className="max-w-md p-8">
            ...
            <div className="text-center space-y-3 mt-6">
              ...
              <p className="opacity-70">
                Practice conversatons, make friends, and improve your language
                skills together.
              </p>
            </div>
          </div>
